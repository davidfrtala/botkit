...
declare type BotkitMessageTemplateAsync = (activity: Activity, values: any) => Promise<Partial<BotkitMessageTemplate>> | Promise<string>;
/**
...
export declare class BotkitConversation<O extends object = {}> extends Dialog<O> {
     ...
     */
    say(message: Partial<BotkitMessageTemplate> | BotkitMessageTemplateAsync | string): BotkitConversation;
    /**
     ...
     */
    addMessage(message: Partial<BotkitMessageTemplate> | BotkitMessageTemplateAsync | string, thread_name: string): BotkitConversation;
    /**
     ...
     */
    ask(message: Partial<BotkitMessageTemplate> | BotkitMessageTemplateAsync | string, handlers: BotkitConvoTrigger | BotkitConvoTrigger[], key: {
        key: string;
     ...
     * @param thread_name Name of thread to which message will be added
     */
    addQuestion(message: Partial<BotkitMessageTemplate> | BotkitMessageTemplateAsync | string, handlers: BotkitConvoTrigger | BotkitConvoTrigger[], key: {
        key: string;
